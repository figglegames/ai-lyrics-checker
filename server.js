  ...
  try {
    const completion = await openai.createChatCompletion({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert in music and songwriting. When given a set of lyrics, determine whether they are likely written by a human or generated by AI. If the lyrics clearly match or contain a known published song title, recognize that and treat it as human-written. Be concise — respond in strict JSON only."
        },
        {
          role: "user",
          content: prompt + "\n\nRespond only with the JSON object. Do not include explanations, markdown, or commentary outside the JSON."
        }
  ]
